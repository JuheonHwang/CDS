...
if __name__ == '__main__':
    ...
    parser.add_argument('--initial_mesh', type=str, default="vh32", help="Initial mesh, either a path or one of [vh16, vh32, vh64, vh128, vh256, sphere16]")
    ...
    parser.add_argument('--iterations', type=int, default=6000, help="Total number of iterations")
    #parser.add_argument('--iterations', type=int, default=5000, help="Total number of iterations")
    ...
    parser.add_argument('--lr_shader', type=float, default=5e-4, help="Step size/learning rate for the shader parameters")
    #parser.add_argument('--lr_shader', type=float, default=1e-4, help="Step size/learning rate for the shader parameters")
    #parser.add_argument('--lr_shader', type=float, default=1e-5, help="Step size/learning rate for the shader parameters")
    ...
    parser.add_argument('--upsample_iterations', type=int, nargs='+', default=[1000, 2000, 3000, 4000, 5000], help="Iterations at which to perform mesh upsampling")
    #parser.add_argument('--upsample_iterations', type=int, nargs='+', default=[1000, 2000, 3000, 4000], help="Iterations at which to perform mesh upsampling")
    ...
    #parser.add_argument('--weight_normal', type=float, default=0.4, help="Weight of the normal term")
    #parser.add_argument('--weight_laplacian', type=float, default=160.0, help="Weight of the laplacian term")
    parser.add_argument('--weight_normal', type=float, default=0.6, help="Weight of the normal term")
    parser.add_argument('--weight_laplacian', type=float, default=240.0, help="Weight of the laplacian term")
    #parser.add_argument('--weight_normal', type=float, default=0.5, help="Weight of the normal term")
    #parser.add_argument('--weight_laplacian', type=float, default=200.0, help="Weight of the laplacian term")
    #parser.add_argument('--weight_normal', type=float, default=1.6, help="Weight of the normal term")
    #parser.add_argument('--weight_laplacian', type=float, default=640.0, help="Weight of the laplacian term")
    #parser.add_argument('--weight_normal', type=float, default=6.4, help="Weight of the normal term")
    #parser.add_argument('--weight_laplacian', type=float, default=2560.0, help="Weight of the laplacian term")
    #parser.add_argument('--weight_shading', type=float, default=1.0, help="Weight of the shading term")
    parser.add_argument('--weight_shading', type=float, default=1.0, help="Weight of the shading term")
    parser.add_argument('--shading_percentage', type=float, default=1, help="Percentage of valid pixels considered in the shading loss (0-1)")
    ...
    #parser.add_argument('--hidden_features_size', type=int, default=128, help="Width of the hidden layers in the neural shader")
    parser.add_argument('--hidden_features_size', type=int, default=64, help="Width of the hidden layers in the neural shader")
    parser.add_argument('--kernel_size', type=int, default=3, help="2D convolution kernel size")
    parser.add_argument('--stride', type=int, default=1, help="2D convolution stride")
    ...
    #parser.add_argument('--activation', type=str, default='softplus', choices=(['relu', 'sine']), help="Activation function used in the neural shader")
            ...
            with torch.no_grad():
                ...
                if iteration == args.iterations:
                    ...
                    for vi in range(len(views)):
                      ...
                      # Save the shaded rendering
                      shaded_image = shader(position, normal, view_direction) * debug_gbuffer["mask"] + (1-debug_gbuffer["mask"])
                      shaded_path = (images_save_path / str(vi) / "final_shaded") if use_fixed_views else (images_save_path / "final_shaded")
                      shaded_path.mkdir(parents=True, exist_ok=True)
                      plt.imsave(shaded_path / f'neuralshading_{cnt_}.png', shaded_image.cpu().numpy())
                      cnt_ += 1
