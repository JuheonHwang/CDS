...
class UNET_specular(nn.Module):
    def __init__(self, in_features, out_features, kernel_size, stride, hidden_features: List[int], activation='relu', last_activation=None, bias=True, first_omega=30, hidden_omega=30.0):
        ...
        # Third layer
        self.upconv1 = nn.ConvTranspose2d(in_channels=hidden_features[1], out_channels=hidden_features[0], kernel_size=2, stride=2)
    ...
    def forward(self, x):
        ...
        cat1 = torch.cat([layer1, upconv1], dim=1)
        layer3 = self.conv3(cat1)
